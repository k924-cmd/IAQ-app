...
import { getDeviceMeta } from '../mocks/devices.js?v=20260803-4';
import { formatObservedAt, getConnectionPresentation, getDeviceStateLabel, getSourceLabel } from '../presentation.js?v=20260803-4';
