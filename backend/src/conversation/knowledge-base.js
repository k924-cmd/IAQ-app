const entries = [
  ...
  },
  {
    topic: "ventilation",
    pattern: /通风|换气/,
    content: "通风可以稀释室内积聚的二氧化碳、气味和部分污染物，但是否适合开窗还要考虑室外空气、天气和人身安全。智能窗户的任何实际状态改变在 V1 中都必须经过确认。",
  },
  {
    topic: "air_purifier",
    pattern: /空气净化器|净化器/,
  ...
  },
  {
    topic: "smart_window",
    pattern: /智能窗户|窗户/,
    content: "智能窗户在 V1 中支持打开和关闭，但每次状态改变都需要用户确认。是否适合开窗应结合室外环境、天气和安全条件，知识说明本身不会触发设备动作。",
  },
  {
    topic: "range_hood",
    pattern: /抽油烟机|油烟机/,
